 ...
 * "error".
 *
 * @version CVS $Revision: 494012 $ $Date: 2007-01-08 10:23:58 +0000 (Mon, 08
 *          Jan 2007) $
 */
public interface Mail extends Serializable, Cloneable {
	 ...
	 * 
	 * @param recipients
	 *            a Collection of MailAddress Objects representing the
	 *            recipients of this message
	 * @since Mailet API v3.0-unstable
	 */
	void setRecipients(List<MailAddress> recipients);
	 ...
	 * Mailet API specification reserves names matching

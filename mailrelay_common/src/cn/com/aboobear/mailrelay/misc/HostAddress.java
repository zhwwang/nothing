...
public class HostAddress extends javax.mail.URLName {
	...
	/*
	 * public static void main(String[] args) throws Exception { HostAddress
	 * url; try { url = new HostAddress("mail.devtech.com", "smtp://" +
	 * "66.112.202.2" + ":25"); System.out.println("Hostname: " +
	 * url.getHostName()); System.out.println("The protocol is: " +
	 * url.getProtocol()); System.out.println("The host is: " + url.getHost());
	 ...
	 * System.out.println("The ref is: " + url.getRef()); } catch (Exception e)

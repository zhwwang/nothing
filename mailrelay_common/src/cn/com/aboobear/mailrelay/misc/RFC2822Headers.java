...
/**
 * This utility class provides the set of header names explicitly defined in RFC
 * 2822
 *
 */
public class RFC2822Headers {
	...
	/**
	 * The name of the RFC 2822 header that stores the actual mail transmission
	 * agent, if this differs from the author of the message.
	 */
	...
	/**
	 * A common variation on the name of the RFC 2822 header that stores the
	 * message id. This is needed for certain filters and processing of incoming
	 * mail.
	 */
	...
	/**
	 * The name of the RFC 2822 header that stores the transmission agent of the
	 * resent message.
	 */
	public final static String RESENT_SENDER = "Resent-Sender";

	/**
	 * The name of the RFC 2822 header that stores the recipients of the resent
	 * message.
	 */
	 ...
	 * recipients of the resent message.
	 */
	public final static String RESENT_BCC = "Resent-Bcc";

	/**
	 * The name of the RFC 2822 header that stores the message id of the resent
	 * message.
	 */

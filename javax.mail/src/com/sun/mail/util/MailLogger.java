...
import javax.mail.MailRelayFormatter;
...
public final class MailLogger {
	...
	private static Logger SMTPDLOGGER = null;
	
	public static void setMailDebugLogger(Logger exlogger) {
		MailLogger.SMTPDLOGGER = exlogger;
	}
	
	public static void PrintTrafficLog(String message) {
		if (MailLogger.SMTPDLOGGER != null && message != null) {
			MailLogger.SMTPDLOGGER.info(message);
		}
	}
